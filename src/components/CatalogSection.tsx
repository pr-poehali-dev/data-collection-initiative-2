...
const plugins = [
  {
    ...
    version: "2.21.0",
    description:
      "Незаменимый плагин для любого сервера. Добавляет сотни базовых команд: /home, /tp, /spawn, /kit, /msg и десятки других. Включает экономику, варпы, ники и управление игроками.",
  ...
  },
  {
    ...
    version: "1.7.3",
    description:
      "Стандарт экономики для Minecraft-серверов. Позволяет плагинам взаимодействовать между собой через единый API для денег, прав и чата. Обязателен для большинства экономических плагинов.",
  ...
  },
  {
    ...
    version: "7.0.11",
    description:
      "Мощная система защиты регионов. Создавайте охраняемые зоны, запрещайте PvP, взрывы, постройки и гриферство в любой части мира. Идеален для выживания и городских серверов.",
  ...
  },
  {
    ...
    version: "0.9.8",
    description:
      "Полноценная реализация BedWars для вашего сервера. Автоматические арены, магазин, команды, генераторы ресурсов, рейтинговая система. Настраивается до мелочей.",
  ...
  },
  {
    ...
    version: "5.4.130",
    description:
      "Лучший плагин управления правами. Группы, наследование, контекстные разрешения, веб-редактор, синхронизация между серверами. Незаменим для любого серьёзного проекта.",
  ...
  },
  {
    ...
    version: "7.3.9",
    description:
      "Система приватных участков для творческих серверов. Игроки получают личные плоты, могут строить, приглашать друзей и защищать свои постройки. Богатая система флагов.",
  ...
  },
  {
    ...
    version: "3.7.0",
    description:
      "Онлайн-карта вашего мира в реальном времени прямо в браузере. Показывает игроков, постройки, биомы и регионы. Поддерживает несколько миров и кастомные маркеры.",
  ...
  },
  {
    ...
    version: "1.12.0",
    description:
      "Популярная мини-игра SkyWars с готовыми аренами, сундуками, системой очков и рейтингом. Поддерживает соло и командный режим. Простая настройка через конфиг.",
  ...
  },
  {
    ...
    version: "6.2.0.8",
    description:
      "Простые в создании магазины прямо в сундуках. Игроки продают и покупают предметы без команд — достаточно кликнуть по сундуку. Полная интеграция с Vault.",
